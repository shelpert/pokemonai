...
turns = 0
with open ('BattleOverview.csv', 'w', encoding='UTF8', newline = '') as fo:
    ...
    with open ('BattleData.csv', 'w', encoding='UTF8', newline = '') as f:
        ...
        while pyboy.tick():
            # print (pyboy.memory[0xD0D8]) // damage pokemon is about to do, doesn't factor leech seed
            # print (str(pyboy.memory[0xD05E]) + ' ' + str(pyboy.memory[0xD0D8])) 
